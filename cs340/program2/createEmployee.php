...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($Fname)) {
        ...
        !filter_var($Fname, FILTER_VALIDATE_REGEXP, [
    ...
    if (empty($Lname)) {
        ...
        !filter_var($Lname, FILTER_VALIDATE_REGEXP, [
            "options" => ["regexp" => "/^[a-zA-Z\s]+$/"],
        ])
    ) {
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form action="<?php echo htmlspecialchars(
            ...
            <div class="form-group <?php echo !empty($Ssn_err)
                ? "has-error"
                : ""; ?>">
              <label>SSN</label>
            ...
            <div class="form-group <?php echo !empty($Fname_err)
                ? "has-error"
                : ""; ?>">
            ...
            <div class="form-group <?php echo !empty($Lname_err)
                ? "has-error"
                : ""; ?>">
            ...
            <div class="form-group <?php echo !empty($Sex_err)
                ? "has-error"
                : ""; ?>">
              <label>Sex</label>
            ...
            <div class="form-group <?php echo !empty($Birth_err)
                ? "has-error"
                : ""; ?>">
            ...
            <div class="form-group <?php echo !empty($Dno_err)
                ? "has-error"
                : ""; ?>">
              <label>Dno</label>
